...
class JobItemDetails extends Component {
    ...
    return (
      <div className="full-job-item-container">
        <div className="job-items-cont">
          ...
          <div className="location-type-salary-cont">
  ...
  renderLoadingView = () => (
    <div className="profile-loader-cont" data-testid="loader">
  ...
  render() {
    return (
      <>
        <Header />
        <div className="get-products-details-cont">{this.renderJobViews()}</div>
      </>
    )
  }
}
